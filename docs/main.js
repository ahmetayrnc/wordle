...
var $author$project$Main$Model = F5(
	function (wordList, answer, currentAttempt, previousAttempts, endGameModalState) {
		return {answer: answer, currentAttempt: currentAttempt, endGameModalState: endGameModalState, previousAttempts: previousAttempts, wordList: wordList};
	});
...
var $author$project$Main$wordToString = function (word) {
	return $elm$core$String$fromList(
		_List_fromArray(
			[word.l0, word.l1, word.l2, word.l3, word.l4]));
};
var $author$project$Main$doesPreviousAttemptHasTheAnswer = F2(
	function (previousAttempts, answer) {
		return A2(
			$elm$core$List$member,
			answer,
			A2($elm$core$List$map, $author$project$Main$wordToString, previousAttempts));
	});
var $author$project$Main$numAttempts = 6;
var $author$project$Main$determineGameState = F2(
	function (previousAttempts, answer) {
		return A2($author$project$Main$doesPreviousAttemptHasTheAnswer, previousAttempts, answer) ? $author$project$Main$Won : (_Utils_eq(
			$elm$core$List$length(previousAttempts),
			$author$project$Main$numAttempts) ? $author$project$Main$Lost : $author$project$Main$OnGoing);
	});
var $elm$json$Json$Decode$decodeValue = _Json_run;
var $elm$json$Json$Decode$array = _Json_decodeArray;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$answersDecoder = $elm$json$Json$Decode$array($elm$json$Json$Decode$string);
var $elm$json$Json$Decode$field = _Json_decodeField;
var $author$project$Main$flagsDecoder = A2($elm$json$Json$Decode$field, 'wordList', $author$project$Main$answersDecoder);
...
var $author$project$Main$initAnswer = function (flags) {
	var _v0 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$flagsDecoder, flags);
	if (_v0.$ === 'Ok') {
		var answers = _v0.a;
		var _v1 = A2($elm$core$Array$get, 0, answers);
		if (_v1.$ === 'Just') {
			var answer = _v1.a;
			return answer;
		} else {
...
var $author$project$Main$Word = F5(
	function (l0, l1, l2, l3, l4) {
		return {l0: l0, l1: l1, l2: l2, l3: l3, l4: l4};
	});
var $author$project$Main$initPreviousAttempts = _List_fromArray(
	[
		A5(
...
var $author$project$Main$initWordSet = function (flags) {
	var _v0 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$flagsDecoder, flags);
	if (_v0.$ === 'Ok') {
		var answers = _v0.a;
...
var $author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		A5(
			...
			$author$project$Main$initWordSet(flags),
			$author$project$Main$initAnswer(flags),
			$elm$core$Maybe$Just(''),
			$author$project$Main$initPreviousAttempts,
			$author$project$Main$determineEndGameModalState(
				A2(
					$author$project$Main$determineGameState,
					$author$project$Main$initPreviousAttempts,
					$author$project$Main$initAnswer(flags)))),
...
var $author$project$Main$keyToMessage = function (key) {
	if (key.$ === 'Character') {
		...
		switch (str) {
			case 'Backspace':
				return $author$project$Main$DeleteInput;
			case 'Enter':
				return $author$project$Main$EnterInput;
			default:
...
var $author$project$Main$keyDecoder = A2(
	...
	function (str) {
		return $author$project$Main$keyToMessage(
			$author$project$Main$toKey(str));
	},
...
var $author$project$Main$addLetterToCurrentAttempt = F2(
	function (letter, model) {
		var _v0 = A2($author$project$Main$determineGameState, model.previousAttempts, model.answer);
		switch (_v0.$) {
			case 'Lost':
...
var $author$project$Main$stringToWord = function (answer) {
	var _v0 = $elm$core$String$toList(answer);
	if (((((_v0.b && _v0.b.b) && _v0.b.b.b) && _v0.b.b.b.b) && _v0.b.b.b.b.b) && (!_v0.b.b.b.b.b.b)) {
		...
		return $elm$core$Result$Ok(
			A5($author$project$Main$Word, l0, l1, l2, l3, l4));
	} else {
		return $elm$core$Result$Err('length != 5');
	}
};
var $author$project$Main$addNewAttempt = function (model) {
	var _v0 = A2($author$project$Main$determineGameState, model.previousAttempts, model.answer);
	switch (_v0.$) {
		case 'Lost':
			return $elm$core$Result$Err('Game already lost');
		...
		default:
			...
			if (_v1.$ === 'Nothing') {
				...
				var attempt = _v1.a;
				var _v2 = $author$project$Main$stringToWord(attempt);
				if (_v2.$ === 'Err') {
					var error = _v2.a;
					return $elm$core$Result$Err(error);
				} else {
					var a = _v2.a;
					return (!A2($elm$core$Set$member, model.answer, model.wordList)) ? $elm$core$Result$Err('Isn\'t in the word list') : $elm$core$Result$Ok(
						A2(
							$elm$core$List$append,
							model.previousAttempts,
							_List_fromArray(
								[a])));
				}
			}
...
var $author$project$Main$deleteLetterFromCurrentAttempt = function (model) {
	var _v0 = A2($author$project$Main$determineGameState, model.previousAttempts, model.answer);
	switch (_v0.$) {
		case 'Lost':
			return $elm$core$Result$Err('Game already lost');
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'LetterInput':
				var letter = msg.a;
				var _v1 = A2($author$project$Main$addLetterToCurrentAttempt, letter, model);
				if (_v1.$ === 'Err') {
			...
			case 'DeleteInput':
				var _v2 = $author$project$Main$deleteLetterFromCurrentAttempt(model);
				if (_v2.$ === 'Err') {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				} else {
			...
			case 'EnterInput':
				var _v3 = $author$project$Main$addNewAttempt(model);
				if (_v3.$ === 'Err') {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				} else {
						...
						_Utils_update(
							model,
							{
								...
								endGameModalState: $author$project$Main$determineEndGameModalState(
									A2($author$project$Main$determineGameState, previousAttempts, model.answer)),
...
var $author$project$Main$decideLetterColor = F3(
	function (index, letter, answer) {
		var letterStr = $elm$core$String$toLower(
			$elm$core$String$fromChar(letter));
		var letterColor = _Utils_eq(
			A3($elm$core$String$slice, index, index + 1, answer),
			letterStr) ? $author$project$Main$Green : (A2($elm$core$String$contains, letterStr, answer) ? $author$project$Main$Yellow : $author$project$Main$Gray);
		return _Utils_Tuple2(letter, letterColor);
	});
var $author$project$Main$decideAttemptColors = F2(
	function (answer, previousAttempt) {
		return A2(
			$elm$core$List$indexedMap,
			function (index) {
				return function (letter) {
					return A3($author$project$Main$decideLetterColor, index, letter, answer);
				};
			},
			$elm$core$String$toList(
				$author$project$Main$wordToString(previousAttempt)));
	});
...
var $author$project$Main$usedLetters = F2(
	function (previousAttempts, answer) {
		return $elm$core$Dict$fromList(
			A2(
				...
				$elm$core$List$concat(
					A2(
						$elm$core$List$map,
						$author$project$Main$decideAttemptColors(answer),
						previousAttempts))));
	});
		...
		var letterDivs = A2(
			...
			function (_char) {
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('letter-box')
						]),
					_List_fromArray(
						[
...
var $author$project$Main$viewDeleteButton = A2(
	$elm$html$Html$button,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('material-icons-outlined'),
...
var $author$project$Main$viewFutureAttempt = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('attempt')
...
var $author$project$Main$viewFutureAttempts = function (numPreviousAttempts) {
	return A2($elm$core$List$repeat, ($author$project$Main$numAttempts - numPreviousAttempts) - 1, $author$project$Main$viewFutureAttempt);
};
var $author$project$Main$viewHelpButton = A2(
	$elm$html$Html$button,
	_List_fromArray(
		[
...
var $author$project$Main$viewPreviousAttempt = F2(
		...
		var letterColor = function (index) {
			return function (letter) {
				return $author$project$Main$letterColorToColorString(
					A3($author$project$Main$decideLetterColor, index, letter, answer).b);
			};
		};
		return A2(
			$elm$core$List$indexedMap,
			...
			$elm$core$String$toList(
				$author$project$Main$wordToString(attempt)));
	});
var $author$project$Main$viewPreviousAttempts = F2(
	function (attempts, answer) {
		return A2(
			$elm$core$List$map,
			$elm$html$Html$div(
				_List_fromArray(
			...
			A2(
				$elm$core$List$map,
				function (attempt) {
					return A2($author$project$Main$viewPreviousAttempt, attempt, answer);
				},
				attempts));
	});
var $author$project$Main$viewSettingsButton = A2(
	$elm$html$Html$button,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('material-icons'),
				...
				_List_fromArray(
					[
						...
						$elm$core$List$concat(
							_List_fromArray(
								[
									A2($author$project$Main$viewPreviousAttempts, model.previousAttempts, model.answer),
						...
						$elm$core$List$concat(
							_List_fromArray(
								[
									...
									A2($author$project$Main$usedLetters, model.previousAttempts, model.answer)),
